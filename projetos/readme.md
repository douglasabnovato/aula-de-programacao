...
A **Escola de Programação** reúne **59 projetos práticos**, cada um em sua própria pasta, documentando uma trajetória real de aprendizado em desenvolvimento web — não um curso fechado, mas um catálogo crescente de exercícios, desafios e ferramentas construídos ao longo do tempo.
...
> Os documentos `readme-1.md` (plano de conteúdos da formação) e `readme-2.md`
> (metodologia e roteiro de aula) foram movidos para o repositório
> **aula-de-programacao**, em `docs/`, que é onde a formação é entregue.
